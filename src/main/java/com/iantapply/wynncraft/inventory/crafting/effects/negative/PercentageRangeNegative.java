 ...
 *
 * What this should look like in lore: "Value:TypeId:EffectId" under the flag of a random UUID
 *
 */
@Getter @Setter
public class PercentageRangeNegative extends NegativeRange {
    private String name;
     ...
     */
    public PercentageRangeNegative(String name, String nbtKey, int min, int max) {
        this.name = name;
        this.nbtKey = nbtKey;
        this.min = min;
        this.max = max;
    ...
    public Component lore() {
        return Component.text("-" + this.min).color(NamedTextColor.RED)
                .append(Component.text(" to ").color(NamedTextColor.DARK_RED))
